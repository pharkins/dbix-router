...
Perhaps a little code snippet.
    ...
    my $foo = DBIx::Router::RuleList->new();
    ...
...
Please report any bugs or feature requests to C<bug-dbix-router-rulelist at rt.cpan.org>, or through
