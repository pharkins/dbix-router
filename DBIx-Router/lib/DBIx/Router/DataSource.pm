...
Perhaps a little code snippet.
    ...
    use DBIx::Router::DataSource;

    my $foo = DBIx::Router::DataSource->new();
    ...
...
Please report any bugs or feature requests to C<bug-dbix-router-datasource at rt.cpan.org>, or through
...
1; # End of DBIx::Router::DataSource
